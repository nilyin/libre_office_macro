![logo](img_libre_office_export/header-logo.png)  
...
[1. Введение](#ch1--введение)  
  
  
[2. Стили текста](#ch2--стили-текста)  
  
  
[2.1. Ссылки](#ch2-1--ссылки)  
  
  
[2.2. Списки](#ch2-2--списки)  
  
  
[2.3. Цитата](#ch2-3--цитата)  
  
  
[2.4. Исходный код](#ch2-4--исходный-код)  
  
  
[3. Таблицы](#ch3--таблицы)  
  
  
[4. Картинки](#ch4--картинки)  
  
  
[4.1. Картинка вне текста](#ch4-1--картинка-вне-текста)  
  
  
[4.2. Картинка внутри текста (Inline Image)](#ch4-2--картинка-внутри-текста-inline-image)  
  
  
[5. Вставка раздела](#ch5--вставка-раздела)  
  
  
[6. Формулы](#ch6--формулы)  
  
  
[6.1. Вставка формулы в виде картинки](#ch6-1--вставка-формулы-в-виде-картинки)  
  
  
[6.2. Вставка формулы в виде объекта LibreOffice Math](#ch6-2--вставка-формулы-в-виде-объекта-libreoffice-math)  
  
  
[7. Оглавление](#ch7--оглавление)  
  
  
[8. Обработка картинок в хедере и тексте](#ch8--обработка-картинок-в-хедере-и-тексте)  
  
  
[9. Обработка текста со строками с новой строки (line-breaks)](#ch9--обработка-текста-со-строками-с-новой-строки-line-breaks)  
  
  
[10. Тестовый раздел с точками версии SP.01](#ch10--тестовый-раздел-с-точками-версии-sp01)  
  
  
  

# <a id="ch1--введение"></a>1. Введение  
...
# <a id="ch2--стили-текста"></a>2. Стили текста  
...
# <a id="ch2-1--ссылки"></a>2.1. Ссылки  
...
# <a id="ch2-2--списки"></a>2.2. Списки  
...
# <a id="ch2-3--цитата"></a>2.3. Цитата  
...
# <a id="ch2-4--исходный-код"></a>2.4. Исходный код  
...
# <a id="ch4--картинки"></a>4. Картинки  
...
# <a id="ch4-1--картинка-вне-текста"></a>4.1. Картинка вне текста  
...
# <a id="ch4-2--картинка-внутри-текста-inline-image"></a>4.2. Картинка внутри текста (Inline Image)  
...
# <a id="ch5--вставка-раздела"></a>5. Вставка раздела  
...
# <a id="ch6--формулы"></a>6. Формулы  
  

# <a id="ch6-1--вставка-формулы-в-виде-картинки"></a>6.1. Вставка формулы в виде картинки  
...
# <a id="ch6-2--вставка-формулы-в-виде-объекта-libreoffice-math"></a>6.2. Вставка формулы в виде объекта LibreOffice Math  
...
# <a id="ch7--оглавление"></a>7. Оглавление  
...
# <a id="ch8--обработка-картинок-в-хедере-и-тексте"></a>8. Обработка картинок в хедере и тексте  
Картинки, которые имеют ссылку, остаются с этой ссылкой в экспорте;  
Картинки, напрямую вставленные как image выделяются и сохраняются в виде файлов в папке img (если имени нет, то оно создается);  
...
<img inline="true" src="img_libre_office_export/Image2.png" />  
  
Картинка ЭКООС выше.  
  
  
<spoiler title="New sections were added below — it is a spoiler frame’s title">  
  
New spoiler frame section test, showing the output  
</spoiler>  

# <a id="ch9--обработка-текста-со-строками-с-новой-строки-line-breaks"></a>9. Обработка текста со строками с новой строки (line-breaks)  
markdown не обрабатывает традиционные line-breaks, ему необходимо указывать двойной пробел, который он воспринимает как новая строка. Пример  
Это новая строка,  
This is new line in paragraph also;  
etc  
  
  

# <a id="ch10--тестовый-раздел-с-точками-версии-sp01"></a>10. Тестовый раздел с точками версии SP.01  
Проверка добавления новых разделов  
