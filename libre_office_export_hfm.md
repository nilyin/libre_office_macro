...
[9. Обработка текста со строками с новой строки (line-breaks)](#9-обработка-текста-со-строками-с-новой-строки-line-breaks)  
  
  
[10. Тестовый раздел](#10-тестовый-раздел)  
...
# 9. Обработка текста со строками с новой строки (line-breaks)  
